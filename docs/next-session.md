...
- **우리 학교 대출 랭킹 = 종이책 실대출**(`semyung_loan_rank`, OPAC popularloanList 1년, 게임제외) 50권, 대출횟수 표시(1위 사랑의기술 40회). 전자책 베스트(숫자없음)에서 전환
- 워크플로 semyung-new.yml = 매일 3개 스크립트(전자신착·종이신착·대출랭킹) 실행
